  ...
  return (
    <motion.div
      className={cn(
        ...
        isPlaying
          ? "ring-2 ring-[#ff6b3d] shadow-lg shadow-[#ff6b3d]/20"
          : "hover:shadow-xl hover:shadow-[#ff6b3d]/10"
      )}
      ...
      {!isPlaying && (
        <div className="absolute bottom-0 left-0 right-0 p-3 flex items-center gap-2 z-30">
          <motion.div
            ...
            whileHover={{
              scale: 1.1,
              backgroundColor: "rgba(255, 107, 61, 0.6)",
            }}
          >
          ...
          {showControls && (
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-white bg-[#ff6b3d]/80 px-2 py-0.5 rounded-full">
                    {video.tag}
                  </span>
...
export default function ShortFormContent() {
  ...
  return (
    <section
      className="relative w-full py-16 px-4 md:px-8 lg:px-16 bg-[#0c0c0c]"
      ref={ref}
    >
      ...
      <div className="container relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl">
            Engaging short-form videos optimized for social media platforms.
          ...
          {!isMobile && (
            <>
              <motion.button
                ...
                whileHover={{
                  scale: 1.1,
                  boxShadow: "0 0 15px 2px rgba(255, 107, 61, 0.3)",
                }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          {isMobile ? (
                  ...
                  <motion.button
                    ...
                    className={cn(
                      ...
                      activeVideoIndex === index ||
                        (activeVideoIndex === null && index === currentPage)
                        ? "bg-[#ff6b3d] w-6"
            ...
            >
                ...
                >
                  ...
                  {shortFormVideos.map((video, index) => (
                    <VideoItem
                      ...
                      isPlaying={
                        activeVideoIndex === index + shortFormVideos.length
                      }
                      onPlay={(i) =>
                        handleVideoPlay(i - shortFormVideos.length)
                      }
                    />
                  ))}
                </motion.div>
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-2">
                <div
                  className={`text-xs text-gray-500 bg-black/30 px-3 py-1 rounded-full backdrop-blur-sm transition-opacity duration-300 ${
                    isPaused ? "opacity-100" : "opacity-0"
                  }`}
                >
                  {isPaused ? "Paused" : "Playing"} • Hover to pause • Touch to
                  interact
                </div>
              </div>
