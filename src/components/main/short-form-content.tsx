...
// import { MoreVertical, Play, ChevronLeft, ChevronRight } from "lucide-react"
...
//     {
//         title: "WHY 95%",
//         vimeoId: "824804225", // Example Vimeo ID
//         tag: "S2 V1",
//         author: "Ahmad Tiasan",
//         thumbnail: "/placeholder.svg?height=600&width=400", // Replace with actual thumbnails
//         duration: "0:15",
//     },
//     {
...
//             iframe.src = `https://player.vimeo.com/video/${video.vimeoId}?autoplay=1&loop=0&title=0&byline=0&portrait=0&controls=1&transparent=0&dnt=1`
...
//                 isPlaying ? "ring-2 ring-[#ff6b3d]" : "hover:shadow-xl",
//             )}
...
//                     >
//                         <motion.div
//                             className="w-16 h-16 rounded-full bg-[#ff6b3d]/90 flex items-center justify-center"
//                             initial={{ scale: 0.8 }}
//                             animate={{ scale: 1 }}
...
//                     <div className="w-8 h-8 rounded-full bg-[#ff6b3d] flex items-center justify-center text-white shadow-lg">
...
//             {/* Title overlay */}
//             {!isPlaying && (
//                 <div className="absolute left-0 right-0 bottom-16 p-3 z-30">
//                     <h3 className="text-white text-xl font-bold drop-shadow-lg whitespace-pre-line">{video.title}</h3>
//                 </div>
//             )}
...
//                 <div className="absolute top-0 left-0 w-1/3 h-1/3 bg-[#ff6b3d]/5 blur-[120px] rounded-full"></div>
//                 <div className="absolute bottom-0 right-0 w-1/4 h-1/4 bg-[#ff4d00]/5 blur-[100px] rounded-full"></div>
//                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2 bg-[#ff6b3d]/3 blur-[150px] rounded-full opacity-20"></div>
//             </div>
...
//                 >
//                     <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-4 rounded-full backdrop-blur-sm border border-gray-800">
//                         <span className="text-[#ff6b3d] text-xs" aria-hidden="true">
//                             ★
//                         </span>
...
//                         <span className="bg-gradient-to-r from-[#ff6b3d] to-[#ff4d00] text-transparent bg-clip-text">Content</span>
//                     </h2>
...
//                     {/* Navigation arrows for tablet and desktop */}
//                     {!isMobile && (
//                         <>
//                             <button
//                                 className="absolute -left-4 md:left-0 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center text-white hover:bg-[#ff6b3d]/80 transition-colors"
...
//                             <button
//                                 className="absolute -right-4 md:right-0 top-1/2 -translate-y-1/2 z-30 w-10 h-10 rounded-full bg-black/50 backdrop-blur-sm flex items-center justify-center text-white hover:bg-[#ff6b3d]/80 transition-colors"
...
//                     <motion.button
//                         className="px-6 py-3 rounded-full bg-gradient-to-r from-[#ff6b3d] to-[#ff4d00] text-white font-medium hover:shadow-lg hover:shadow-[#ff6b3d]/20 transition-all"
                                    ...
                                    <motion.button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            if (navigator.share) {
                                                ...
                                                navigator.clipboard.writeText(`https://vimeo.com/${video.vimeoId}`)
                                                // Toast notification
